            ...
            if T1 == T2 :
                ...
                if not right_pose_condition:
                    ...
                    if right_outside_con == 1 and right_limit_workspace_time <= 6:
                        ...
                        print right_limit_workspace_time
                        if (right_limit_workspace_time%3 == 0):
                            right_outside_con = 0
                if ((right_limit_workspace_time%4 == 0) and (right_arm_joint_state[7] <= 0.015)) or right_limit_workspace_time > 6:
                    print "============ right_con2 ============"
                    yumi.right_arm_go_to_pose_goal()
                    right_outside_con = 1
