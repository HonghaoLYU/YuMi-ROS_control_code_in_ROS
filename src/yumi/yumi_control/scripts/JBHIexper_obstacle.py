...
class MoveGroupPythonInteface(object):
    ...
    def set_scene(self):
        ...
        cover3_id = 'cover3'
        # 设置约束形状的三维尺寸
        top_size = [0.05, 1.3, 0.05]
        top1_size = [0.05, 0.8, 0.05]
        box1_size = [0.05, 0.05, 1.05]
        box2_size = [0.05, 0.05, 1.05]
        box3_size = [0.05, 0.05, 1.0]
        ...
        box2_pose.pose.position.y = -0.66
